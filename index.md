...
* adding some [built-in commands](#built-in-commands) like autosol,
...
\<command>
: An IPMI command or a [built-in commands](#built-in-commands).
...
-r, --profile PROFILE
: Load [profile](#profile) from `profiles.toml`.
